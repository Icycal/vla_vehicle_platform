...
def generate_launch_description():
    ...
    r3s_mec_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.05134 ', '0', '0.09452'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    r3s_4wd_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.03163', '0.00009', '0.09502'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    mini_tank_ = GroupAction(
        ...
        actions=[
            ...
            generate_static_transform_publisher_node(['0.02799', '0.00005', '0.09602'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    mini_4wd_ = GroupAction(
        ...
        actions=[
            ...
            generate_static_transform_publisher_node(['0.03163', '0.00009', '0.09292'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    brushless_senior_diff_ = GroupAction(
        ...
        actions=[
            ...
            generate_static_transform_publisher_node(['0.10115', '0.00', '0.23618'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
