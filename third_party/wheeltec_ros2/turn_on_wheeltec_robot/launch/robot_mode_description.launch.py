...
def generate_launch_description():
    ...
    senior_akm_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.08874 ', '0.00067', '0.11102'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    top_akm_bs_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.23979 ', '0.00017', '0.15302'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    top_akm_dl_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.25033 ', '0.00182', '0.1504'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    senior_mec_bs_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.09113 ', '0.00067', '0.11102'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    senior_mec_dl_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.15699 ', '0.00002', '0.14652'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    top_mec_bs_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.13865 ', '0.00002', '0.12652'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    top_mec_dl_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.14499 ', '0.00002', '0.18652'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    mec_EightDrive_robot_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.26583', '0.00018', '0.19506'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    flagship_mec_bs_robot_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.24699', '0.00002', '0.24466'], ['-1.57', '0', '0'], 'base_link', 'laser'),
    ...
    flagship_mec_dl_robot_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.23835', '0.00002', '0.28466'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    senior_omni_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.06719', '0.0001', '0.12802'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    top_omni_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.144', '0.00018', '0.13806'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    senior_4wd_dl_robot_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.15699', '0.00201', '0.14652'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
    ...
    flagship_4wd_bs_robot_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.24699', '0.00002', '0.24466'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
        generate_static_transform_publisher_node(['0.29879', '0.00024', '0.1722'], ['0', '0', '0'], 'base_footprint', 'camera_link'),      
    ]) 
    ...
    senior_diff_robot_ = GroupAction(
        ...
        generate_static_transform_publisher_node(['0.05911', '0.00016', '0.13416'], ['-1.57', '0', '0'], 'base_footprint', 'laser'),
